...
import br.com.transcript.business.PermissoesBusiness;
import br.com.transcript.business.UsuarioBusiness;
import br.com.transcript.exception.BusinessException;
import br.com.transcript.util.CriptografiaArquivos;
...
public class ArquivoController {
	...
	private String uploadArquivo(MultipartFile file, int idUsuario) {
		...
		if (!file.isEmpty()) {
			try {
				...
				cript.Cript(serverFile.getAbsolutePath(), caminho, "transcript", 'c');
	...
	public void download(String caminho, HttpServletResponse response) {
		...
		try {
			...
			cript.Cript(caminho, caminhoDesc, "transcript", 'd');
